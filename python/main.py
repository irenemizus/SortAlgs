...
if __name__ == '__main__':
    ...
    L_ref = [random.randint(0, msort.MAX) for i in range(10000000)]
    sec_i_ref = time.time()
    L_ref.sort()
    sec_f_ref = time.time()
    ...
    # QuickSortSimpleList
    L_sl = random.sample(range(0, msort.MAX), 10)
    ...
    # MergeSortRecursive
    IN_rec = random.sample(range(0, msort.MAX), 13)
    ...
    IN_sl = random.sample(range(0, msort.MAX), 12)
    ...
    print("\nLength\tT_qsll\tT_sqsl\tT_qsr\tT_msll\tT_mssl\tT_msr")
